<section id="sidebar">
    ...
    <div class="sidebar-list" data-simplebar>
        <div class="sidebar-list-item <?php echo e($currentRoute == "account.chat.home" ? 'item-selected' : null); ?>">
        ...
        <div class="sidebar-list-item <?php echo e($currentRoute == "account.report.home" ? 'item-selected' : null); ?>">
            <div class="sidebar-icon">
        ...
        <div class="sidebar-list-item <?php echo e($currentRoute == "account.broadcast.home" ? 'item-selected' : null); ?>">
            <div class="sidebar-icon">
